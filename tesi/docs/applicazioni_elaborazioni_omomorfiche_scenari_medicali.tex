...
In questo capitolo si considera un'applicazione concreta delle tecniche descritte in precedenza: l'uso della regressione lineare in uno scenario medico. L'idea di fondo \`e semplice. Pi\`u strutture sanitarie o pi\`u soggetti che raccolgono dati clinici vogliono contribuire alla costruzione di un modello statistico, ma senza rinunciare alla protezione delle informazioni trattate.
