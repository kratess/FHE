...
\caption{Heap osservato durante la creazione del contesto, con profondit\`a 16.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\textwidth]{figures/benchmark_bootstrap.png}
\caption{Tempo di bootstrapping in CKKS con profondit\`a 16.}
\label{fig:benchmark_bootstrap}
\end{figure}
