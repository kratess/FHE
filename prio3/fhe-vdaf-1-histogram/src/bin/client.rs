...
use fhe_vdaf_1_histogram::client::run_sample_clients;
...
fn main() -> Result<()> {
    ...
    let expected_bucket_sum = run_sample_clients(&layout)?;
    println!("client stage complete: expected_bucket_sum={expected_bucket_sum}");
    Ok(())
}
